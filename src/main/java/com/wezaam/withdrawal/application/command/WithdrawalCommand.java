...
public class WithdrawalCommand {
    ...
    protected WithdrawalCommand(Long id, Long userId, Long paymentMethodId, BigDecimal amount, Boolean immediate, Instant scheduledFor, WithdrawalStatus withdrawalStatus) {
        this.id = id;
        this.userId = userId;
